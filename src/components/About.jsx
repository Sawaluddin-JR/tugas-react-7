          ...
          <div className="p-2">
            ...
            >
              <p className="text-justify leading-7 w-11/12 mx-auto">
                ...
                mengambil Program Studi S1 Teknik Informatika dan saya sudah
                menjalaninya selama 4 semester penuh dengan rintangan yang
                melewati luas nya samudera dan dalamnya lautan di india.Tetapi
                berkat doa dan support sang ibu saya masih bisa bertahan sampai
                sekarang{" "}
                <span
                  className={`${
                    theme === "light"
